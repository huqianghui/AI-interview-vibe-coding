...
export default defineConfig({
  testDir: ".",
  testMatch: /(voice-live-azure|avatar-diagnostic|avatar-stability-probe|audio-diagnostic|audio-turn2-diagnostic|anon-recovery|readme-live-screenshots|external-interview-live)\.spec\.ts/,
  timeout: 120_000,
